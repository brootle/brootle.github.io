...
function addMarker(place)
{
    ...
    $.getJSON(" https://mashup.cs50.net/articles.php", parameters)
    .done(function(data, textStatus, jqXHR) {
        ...
        {
            //console.log(data);
            content+= '<li><a target="_blank" href="' + data[i].link + ' ">' + data[i].title + '</a></li>';
    ...
    // now we need to add data to conent
    
    // add listerner on a marker that executes on click
...
function search(query, cb)
{
    ...
    $.getJSON(" https://mashup.cs50.net/search.php", parameters)
    .done(function(data, textStatus, jqXHR) {
...
function update() 
{
    ...
    $.getJSON(" https://mashup.cs50.net/update.php", parameters)
    .done(function(data, textStatus, jqXHR) {
